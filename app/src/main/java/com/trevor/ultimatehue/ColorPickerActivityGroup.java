...
public class ColorPickerActivityGroup extends AppCompatActivity implements ActionBar.TabListener, OnColorSelectedListener {

    public static final String TAG = ColorPickerActivityGroup.class.toString();

    private static final int TOTAL_PAGES = 4; // Number of tabs to be shown for the ColorPickers
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 2:
                    // Country Load
                    Log.d(TAG, "Loading CountryEffectColorFragment");
                    return new CountryEffectColorFragment();
                case 3:
                    // Custom Color
                    Log.d(TAG, "Loading CustomColorFragment");
                    return CustomColorFragment.newInstance(lightIdentifier, true);
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                ...
                case 2:
                    return getString(R.string.title_country_color).toUpperCase(l);
                case 3:
