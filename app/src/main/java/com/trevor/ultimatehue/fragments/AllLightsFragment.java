...
import com.trevor.ultimatehue.ColorPickerActivityIndividual;
...
public class AllLightsFragment extends Fragment {

    public static final String TAG = AllLightsFragment.class.toString();
     ...
     * number.
     */
    public static AllLightsFragment newInstance(int sectionNumber) {
        Log.i(TAG, "newInstance");

        AllLightsFragment fragment = new AllLightsFragment();
                ...
                chooseColor.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(light.supportsColor()) {
                            ...
                            Intent intent = new Intent(row.getContext(), ColorPickerActivityIndividual.class);
